...
angular.module('sparkonixWebApp').controller('warProfileController',
		warProfileController);

function warProfileController($scope, $rootScope, restAPIService, dialogs,
		$state) {
